...
\section{Projects}
  \resumeSubHeadingListStart
	...
	\resumeSubItem{Basic Operating System (opsys)}{
			Started a basic operating system project hosted on github to understand and practically apply concepts learned in operating systems coursework. Implemented bootloader for x86 from scratch. Currently just the bootloader, string libraries and basic kernel has been implemented.
	}
